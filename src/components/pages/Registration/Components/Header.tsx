...
function HeaderRegistrationComponent(props: HeaderProps) {
  ...
  const exportData = () => {
    ...
    const exportUrl = `/api/registration/export?${
      ...
      >
        ...
        >
          ...
          <Button
            variant="contained"
            onClick={() =>
              showModal("registration-data-filter", { id: "", type: "filter" })
            }
            sx={{ width: 150, flexShrink: 0 }}
...
export const HeaderRegistration = React.memo(HeaderRegistrationComponent);
