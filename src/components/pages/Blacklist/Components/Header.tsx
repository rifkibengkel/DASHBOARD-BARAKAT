...
function HeaderBlacklistComponent(props: HeaderProps) {
    ...
    >
      ...
      >
        ...
        {pageRole?.m_insert === 1 && (
          <Button
            variant="contained"
            onClick={() => showModal("blacklist", { id: "", type: "create" })}
            sx={{ width: 150 }}
...
export const HeaderBlacklist = React.memo(HeaderBlacklistComponent);
