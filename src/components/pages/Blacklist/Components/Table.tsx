...
export function TableBlacklist(props: BlacklistTableProps) {
                    ...
                    {pageRole.m_update === 1 && (
                        <>
                            <Link
                                ...
                                onClick={() => showModal('blacklist', { id: row.id, type: 'update' })}
                            >
                                Modify
                            </Link>
                            <Link
                                ...
                                onClick={() => showModal('blacklist-delete', { id: row.id, type: 'delete' })}
                            >
                                Delete
                            </Link>
                        </>
