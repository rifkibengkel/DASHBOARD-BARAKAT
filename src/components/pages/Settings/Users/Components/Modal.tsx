...
function ModalUsersComponent({ keys, roles }: { keys: string; roles: Roles[] }) {
    ...
    const schema = modal && modal.type === 'update' ? UserUpdateSchema : UserCreateSchema;
    ...
    React.useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                const response = await fetch(`/api/settings/users/detail?id=${modal.id}`, {
                    method: 'GET',
                });
                if (!response.ok) {
                        ...
                        <Grid container spacing={2}>
                            <Grid size={{ xs: 12 }}>
                                <FormControl fullWidth>
                                    <FormLabel sx={{ color: 'inherit', fontWeight: 500, mb: 1 }}>Username</FormLabel>
                                    <FastField
                                        size="small"
                            ...
                            <Grid size={{ xs: 12 }}>
                                <FormControl fullWidth>
                                    <FormLabel sx={{ color: 'inherit', fontWeight: 500, mb: 1 }}>Fullname</FormLabel>
                                    <FastField
                                        size="small"
                                        component={TextFieldValidation}
                                        name="fullname"
                            ...
                            <Grid size={{ xs: 6 }}>
                                <FormControl fullWidth>
                                    <FormLabel sx={{ color: 'inherit', fontWeight: 500, mb: 1 }}>Role</FormLabel>
                                    <FastField
                                        size="small"
